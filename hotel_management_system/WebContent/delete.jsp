...
<h1>AVENUE:DELETE ROOMS</h1>
<br>
<h2>Select Room From Table to Delete</h2>
...
<p>
<pre>
<FORM align="center" action="DEL_SER" method="post">
<b>
...
<center>
<div class="loginbox">
<input type="submit" name="submit" value="DELETE" onclick="proceed()">
</div>
</center>
<script>
...
alert("hello "+x+" "+y+" Room successfully deleted");
}
