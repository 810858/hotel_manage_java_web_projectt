...
<body>
<ul>
<li><a><a href="nav.html">HOME</a></a></li>
</ul>
<h1>AVENUE: BOOKING</h1><BR>
<P><FONT COLOR="BLUE"><I>SELECT ROOM TYPE</I></FONT></P>
...
<p>
<pre>
<FORM align="center" action="BOOKSER" method="post">
<b>
...
<BR>
FIRST NAME    :<INPUT TYPE="TEXT" VALUE="" SIZE="30"  onfocus="abc(this)" name="namee" id="N" onblur="fn()">
<BR>
LAST NAME     :<INPUT TYPE="TEXT" VALUE="" SIZE="30" onfocus="abc(this)" name="lastt" id="TN" onblur="fn2()">
<BR>
ADDRESS       :<INPUT TYPE="TEXT" VALUE="" SIZE="30" name="addd" onfocus="abc(this)">
<BR>
PHONE         :<INPUT TYPE="TEXT" VALUE="+91" SIZE="30" name="phone" onfocus="abc(this)">
<BR>
---------------------------------------------------------------------------------------------------
<form action="" method="">
...
<option value="GAME LOT">GAME SLOT</OPTION>
</SELECT>
<BR>
---------------------------------------------------------------------------------------------------
<FORM align="center">
<b>
Check In Date   :<INPUT TYPE="date" VALUE="   dd / mm  /yyyy" name="bday" SIZE="30"/>
<BR> 
Check Out Date  :<INPUT TYPE="date" VALUE="   dd / mm /yyyy"  name="bdayy" SIZE="30"/>
<BR>
---------------------------------------------------------------------------------------------------
<BR>
...
<center>
<div class="loginbox">
<input type="submit" name="submit" value="SUBMIT" onclick="proceed()">
</div>
</center>
<script>
...
alert("hello "+x+" "+y+" your room booked successfully");
}
